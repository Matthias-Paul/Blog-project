      ...
      <div className="pt-[80px]  w-full m-auto font-work px-[20px]  ">
       ...
       <form className=" max-w-[600px]" onSubmit={handleSubmit}>
         <div className="font-[600]  text-[24px] border-[#E6E6F0] mb-[40px] border-b-[1px] pb-[20px] text-[#32264D] "> Blog Form</div> 
          ...
          <input className="border p-[12px] text-black sm:p-[20px] rounded-[8px] outline-none mt-[12px] w-[270px] sm:w-[320px] md:w-[400px] lg:w-[600px] " id="title" type="text" />
      
          <label className=" text-[14px] text-[#4E4958] block mt-[40px]  "  htmlFor="description">Description</label>
          <textarea className="border text-black p-[12px] sm:p-[20px] rounded-[8px] outline-none mt-[12px] w-[270px] sm:w-[320px] md:w-[400px] lg:w-[600px] resize-none " rows={4} id="description" type="text" />
