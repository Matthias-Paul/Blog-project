      ...
      <div className="pt-[80px]  w-full m-auto font-work px-[20px]  ">
        <div className="  max-w-[1300px] m-auto sm:px-[20px]  ">
          <div className="mt-[20px] pb-[180px] relative  ">
            <div
              className={`absolute bottom-[30px] sm:bottom-[120px] left-[20px] sm:left-[60px] p-[20px] lg:p-[35px] border shadow-md rounded-[12px] max-w-[300px] md:max-w-[400px] lg:max-w-[600px] ${
                theme === "light"
                  ? "bg-white text-black"
                  : "bg-white text-black"
              } `}
            >
              <h4 className="text-[14px] font-[500] mb-[2px] md:mb-[8px] bg-[#4B6BFB] text-white max-w-[90px] rounded-[6px] px-[8px] py-[4px] ">
                Technology
              </h4>
              <h1 className="text-[#181A2A] font-[600] text-[16px] sm:text-[18px] md:text-[22px] lg:text-[36px] leading-[18px] sm:leading-[25px] md:leading-[30px] max-w-[350px] lg:max-w-[500px] lg:leading-[43px] py-[12px] lg:py-[20px]  ">
              ...
              <div className="flex items-center text-[#97989F] text-[13px] md:text-[16px] font-[500]">
                <div className="max-w-[35px] mr-[5px] sm:mr-[15px] ">
                  {" "}
                  <img className="w-full" src={profileOne} alt="profile" />{" "}
                </div>
                <p className=" mr-[5px] md:mr-[40px] ">Jason Francisco</p>
                <p>August 20, 2022</p>
              </div>
            </div>
            <div className="max-w-[1300px] max-h-[650px]">
              <img
          ...
          <div className="flex justify-between mb-[20px] pt-[30px] sm:pt-[-20px]  ">
            <div className="font-[700] text-[18px] md:text-[24px] ">
              {" "}
              Latest Post
            </div>
            <NavLink to="/blog">
